...
<section class="bg-white" id="features">
   ...
   <div class="max-w-[850px] mx-auto">
    <h1 class="text-center md:text-xl lg:text-3xl text-lg font-bold text-black">Why Choose <span class="text-green-400">SomAtlasAPI?</span></h1>
    <p class="pt-5 md:text-lg lg:text-lg text-base text-center  text-gray-600">SomAtlasAPI is your all-encompassing platform, providing effortless access to explore detailed information on states and districts in Somalia through our seamless API.</p>
   </div>
    <div class="grid gap-4 md:grid-cols-3 sm:grid-cols-1 py-[4rem]">
        <div class="w-full  shadow-2xl bg-black mt-10 py-4 items-center text-center text-white flex flex-col rounded-lg hover:scale-105 duration-300">
            ...
            <div class="font-medium text-center">
                ...
                <p class="py-8  text-base mx-4">Instantly access detailed data on Somalia's states and districts.</p>
            </div>
        </div>
        <div class="w-full shadow-xl bg-green-300 mt-10 py-4  items-center text-center text-black  flex flex-col rounded-lg hover:scale-105 duration-300 ">
            ...
            <div class="font-medium text-center">
                ...
                <p class="py-8  text-base mx-4">Effortlessly integrate location data into your registration process.</p>
            </div>
        </div>
        <div class="w-full shadow-xl bg-black mt-10 py-4 items-center text-center text-white  flex flex-col rounded-lg hover:scale-105 duration-300">
            ...
            <div class="font-medium text-center">
                ...
                <p class="py-8  text-base mx-4">Keep your app current with dynamic geographic information..</p>
            </div>
        </div>
